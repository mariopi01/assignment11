  ...
  return (
    ...
    <Card 
      className={cn(
        ...
        "flex flex-col justify-start items-center p-3 rounded-xl bg-white transition-shadow hover:shadow-lg", 
    ...
    >
      ...
      <div 
        className="flex items-center justify-center p-1.5 rounded-lg h-16 w-full shrink-0" 
        style={{ background: '#E0ECFF' }}
      >
        <img 
            src={icon} 
            alt={`Icon ${name}`} 
            className="size-8 md:size-10 object-contain" // Ukuran icon juga sedikit disesuaikan di mobile agar proporsional
        />
      </div>
      
      
      <p className="font-semibold text-[#0A0D12] text-xs sm:text-sm md:text-base text-center wrap-break-word leading-tight w-full">
        {name}
      </p>
    </Card>
  );
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-4 pt-4">
        ...
        <div className="grid grid-cols-3 gap-3 md:gap-4 lg:grid-cols-6 lg:gap-6">
