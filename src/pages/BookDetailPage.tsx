...
// //   // === MUTASI ADD TO CART (FIXED bookId conversion) ===
// //   const bookIdNumber = Number(bookId); // Konversi string ID ke number di sini
...
// //   >({
// //       mutationFn: ({ qty }) => {
// //           // Kirim bookId sebagai number (integer)
// //           return apiClient.post('/cart/items', { bookId: bookIdNumber, qty });
// //       },
// //       onSuccess: () => {
// //           toast.success('Add to cart successful', { description: 'Buku berhasil ditambahkan ke keranjang.' });
// //       },
// //       onError: (err: ApiError) => {
// //           // Tangani kasus di mana bookIdNumber mungkin NaN atau 0 (seharusnya dicegah oleh router)
// //           const errorMsg = bookIdNumber === 0 || isNaN(bookIdNumber)
// //             ? 'ID buku tidak valid.'
// //             : err.response?.data?.message || 'Gagal menambahkan buku ke keranjang.';
          
// //           toast.error('Add to Cart Gagal', { 
...
// //                 {/* Add to Cart Button (Outline: #D5D7DA) */}
// //                 <Button 
// //                     onClick={() => addToCart({ qty: 1 })} // Panggil mutasi AddToCart
...
//   // Variabel yang dihapus: isReviewsFetching, hasMoreReviews, handleLoadMore
  
//   // === MUTASI ADD TO CART (FIXED bookId conversion) ===
//   // FIX: Menggunakan parseInt() untuk memastikan konversi menjadi integer yang bersih
...
//   >({
//       mutationFn: ({ qty }) => {
//           // Tambahkan pengecekan validitas ID sebelum POST ke API
//           if (isNaN(bookIdNumber) || bookIdNumber <= 0) {
//               return Promise.reject(new Error("Book ID is invalid."));
//           }
//           // Kirim bookId sebagai integer
//           return apiClient.post('/cart/items', { bookId: bookIdNumber, qty });
//       },
//       onSuccess: () => {
//           toast.success('Add to cart successful', { description: 'Buku berhasil ditambahkan ke keranjang.' });
...
//           let errorMsg = 'Gagal menambahkan buku ke keranjang.';
//           if (err instanceof Error) {
//               errorMsg = err.message; // Tangani error dari pengecekan lokal
//           } else {
